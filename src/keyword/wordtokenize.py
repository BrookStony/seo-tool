...
def load_dict(dict_file='D:\dev\python\seo-tool\conf\dict.txt'):
    #加载词库，把词库加载成一个key为首字符，value为相关词的列表的字典
   
    words = [str(line).split() for line in open(dict_file, 'r', encoding='utf-8')]
...
if __name__ == '__main__':
    ...
    tokenize_test(str(u'美丽的花园里有各种各样的小动物'))